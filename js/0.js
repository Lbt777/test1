...
/*!****************************!*\
  !*** ./src/api/request.js ***!
  \****************************/
/*! exports provided: queryConsumeDetails, queryRechargeDetails, queryUserEarningsDetails, queryTheWithdrawalList, queryEarnestMoney, taskCreate, taskUpdate, bidderOwner, taskDetails, taskList, taskOwner, taskBidder, taskBidders, taskBidderStatus, taskLogs, taskOrder, taskStatus, taskOrderStatus, taskBidderDel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "queryConsumeDetails", function() { return queryConsumeDetails; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "queryRechargeDetails", function() { return queryRechargeDetails; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "queryUserEarningsDetails", function() { return queryUserEarningsDetails; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "queryTheWithdrawalList", function() { return queryTheWithdrawalList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "queryEarnestMoney", function() { return queryEarnestMoney; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskCreate", function() { return taskCreate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskUpdate", function() { return taskUpdate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bidderOwner", function() { return bidderOwner; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskOwner", function() { return taskOwner; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskBidder", function() { return taskBidder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskBidders", function() { return taskBidders; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskBidderStatus", function() { return taskBidderStatus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskLogs", function() { return taskLogs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskOrder", function() { return taskOrder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskStatus", function() { return taskStatus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskOrderStatus", function() { return taskOrderStatus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taskBidderDel", function() { return taskBidderDel; });
/* harmony import */ var _service_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./service.js */ "./src/api/service.js");
/*
 * @Author: lbt666 1319451895@qq.com
 * @Date: 2022-06-23 14:24:00
 * @LastEditors: lbt666 '1319451895@qq.com'
 * @LastEditTime: 2022-08-26 09:10:03
 * @Description: 
 */
 // 查询钻石消费明细

function queryConsumeDetails(params, headerData) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/public/charge/queryConsumeDetails',
    method: 'get',
    headers: {
      Authorization: headerData.token,
...
function queryRechargeDetails(params, headerData) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/public/charge/queryRechargeDetails',
    method: 'get',
    headers: {
      Authorization: headerData.token,
      userId: headerData.userId
...
function queryUserEarningsDetails(params, headerData) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/public/charge/queryUserEarningsDetails',
    method: 'get',
    headers: {
      Authorization: headerData.token,
      userId: headerData.userId
...
function queryTheWithdrawalList(params, headerData) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/public/charge/queryTheWithdrawalList',
    method: 'post',
    headers: {
      Authorization: headerData.token,
      userId: headerData.userId
...
function queryEarnestMoney(headerData) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/public/transaction/queryEarnestMoney',
    method: 'get',
    headers: {
      Authorization: headerData.token,
      userId: headerData.userId
...
function bidderOwner(params) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/v1/task/bidder/owner',
    method: 'get',
    params: params
  });
} // 需求详情
...
function taskOwner(params) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/v1/task/owner',
    method: 'get',
    params: params
  });
} // 用户参与需求

function taskBidder(data) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/v1/task/bidder',
    method: 'post',
    data
  });
} // 当前需求的已参与列表

function taskBidders(params) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/v1/task/bidders',
    method: 'get',
    params: params
  });
} // 修改已参与的列表数据状态

function taskBidderStatus(data) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/v1/task/bidder/status',
    method: 'post',
    data
  });
} // 当前需求的动态

function taskLogs(params) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
...
function taskOrder(params) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/v1/task/order',
    method: 'get',
    params: params
  });
} // 修改任务状态
...
function taskBidderDel(data) {
  return Object(_service_js__WEBPACK_IMPORTED_MODULE_0__["Service"])({
    url: '/api/v1/task/bidder/del',
    method: 'post',
    data
  });
}
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/_axios@0.26.1@axios/index.js");
 ...
 * @LastEditors: lbt666 '1319451895@qq.com'
 * @LastEditTime: 2022-10-08 17:54:30
 * @Description: 
 */


 // http://live.sss2.cc
// http://192.168.3.20:9104
...
Service.interceptors.response.use(response => {
  ...
  if (data.code == 200) {
    ...
    Object(vant__WEBPACK_IMPORTED_MODULE_1__["Toast"])(data.msg);
  }
}, error => {
  console.log('TCL: error', error);
  const msg = error.msg !== undefined ? error.msg : '网络错误';
