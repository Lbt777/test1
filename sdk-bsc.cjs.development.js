...
var IComplusV2Pair = _interopDefault(require('@complus/v2-core-bsc/build/contracts/IComplusV2Pair.json'));
...
var FACTORY_ADDRESS = '0xDf97982Bf70be91df4ACD3d511c551F06a0D19eC';
var INIT_CODE_HASH = '0xdace88abf6603478c9c8a5be3404ae565aab41cbfd44ca74995fc13321698f4a';
...
var WBNB = (_WBNB = {}, _WBNB[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB'), _WBNB[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, '0xb8D8b45a1eA8Bcfa1E7e3574879bd699dc7ef3f6', 18, 'WBNB', 'Wrapped BNB'), _WBNB);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'COM-LP', 'Complus LP Token');
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IComplusV2Pair.abi, provider).getReserves()).then(function (_ref) {
...
//# sourceMappingURL=sdk-bsc.cjs.development.js.map
